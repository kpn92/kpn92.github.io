...
function nextExpertise() {
  ...
  if (expertiseIndex >= expertiseCards.length) {
    expertiseIndex = 0;
  }
...
function prevExpertise() {
  ...
  if (expertiseIndex < 0) {
    expertiseIndex = expertiseCards.length - cardsPerView;
  }
...
window.nextExpertise = nextExpertise;
window.prevExpertise = prevExpertise;

// start
document.addEventListener("DOMContentLoaded", updateExpertise);